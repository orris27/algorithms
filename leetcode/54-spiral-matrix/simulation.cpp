...
public:
    ...
    vector<int> spiralOrder(vector<vector<int>>& matrix) {
        ...
        for (int i =0;i<matrix[0].size();++i) // move to the top right in order to ensure that our starting point would not participate in the operation in the loop
        ...
        {
            if (k%2 == 0) // move down to the bottom right or move up to the top left
            {
